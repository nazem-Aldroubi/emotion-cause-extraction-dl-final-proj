...
#    checkpoint.restore(manager.latest_checkpoint)
    ...
    true_pairs = train_embedding_pairs[train_label_pairs==1]
    false_pairs = train_embedding_pairs[train_label_pairs==0]

    # Train filter model.
    num_epochs = 100
    for e in range(num_epochs):
        print("EPOCH ", e)
        pair_filter_model.train(filter_training_pairs, filter_training_labels)
